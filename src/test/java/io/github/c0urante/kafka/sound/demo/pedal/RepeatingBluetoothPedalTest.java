...
public class RepeatingBluetoothPedalTest {

    @Test
    public void testHiddenWindow() throws Exception {
        TestPedal pedal = new TestPedal(100) {
            @Override
            protected void left() {
    ...
    public void testVisibleWindow() throws Exception {
        ...
        TestPedal pedal = new TestPedal(100) {
            ...
            @Override
            protected void left() {
                text.setText("Left (" + left.incrementAndGet() + ")");
            }

            @Override
            protected void right() {
                text.setText("Right (" + right.incrementAndGet() + ")");
            }
        };
    ...
    private static abstract class TestPedal extends RepeatingBluetoothPedal {

        private final CountDownLatch closed;

        public TestPedal(long delay) {
            super(delay, delay);
