...
public class AverageMagnitudeDifference extends TarsosDspPitchAlgorithm{

    public AverageMagnitudeDifference() {
        super(new AMDF(AudioFormats.SAMPLE_RATE, AUDIO_BUFFER_SIZE));
    }
