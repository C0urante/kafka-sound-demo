...
public class McLeodPitchMethod extends TarsosDspPitchAlgorithm {

    public McLeodPitchMethod() {
        super(new be.tarsos.dsp.pitch.McLeodPitchMethod(AudioFormats.SAMPLE_RATE, AUDIO_BUFFER_SIZE));
    }
