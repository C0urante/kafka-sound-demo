...
public class DynamicWavelet extends  TarsosDspPitchAlgorithm {

    public DynamicWavelet() {
        super(new be.tarsos.dsp.pitch.DynamicWavelet(AudioFormats.SAMPLE_RATE, AUDIO_BUFFER_SIZE));
    }
