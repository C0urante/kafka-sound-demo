...
public class LowPassSingleStage extends TarsosDspFilter {

    public LowPassSingleStage(int windowSize, float cutoff) {
        super(
                new LowPassSP(cutoff, (float) AudioFormats.SAMPLE_RATE),
                windowSize
        );
    }
